...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Иначе 
		...
		СоздатьДвижениеВКМ_ВыполненныеРаботыКлиенту(Отказ);
		Если Отказ Тогда
			Возврат;
		КонецЕсли;
...
Процедура СоздатьДвижениеВКМ_ВыполненныеРаботыКлиенту(Отказ)
...
Процедура BKM_ВыполнитьАвтозаполнение() Экспорт
	...
	Запрос.Текст = 
		...
		|	ЕСТЬNULL(ВКМ_ВыполненныеКлиентуРаботыОстаткиИОбороты.Договор.BKM_СтоимостьЧасаРаботыСпециалиста, 0) КАК
		|		ДоговорBKM_СтоимостьЧасаРаботыСпециалиста
		|ПОМЕСТИТЬ ВТ_Обороты
		|ИЗ
		|	РегистрНакопления.ВКМ_ВыполненныеКлиентуРаботы.ОстаткиИОбороты КАК ВКМ_ВыполненныеКлиентуРаботыОстаткиИОбороты
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|	ЕСТЬNULL(ВКМ_ВыполненныеКлиентуРаботы.Договор.BKM_СтоимостьЧасаРаботыСпециалиста, 0)
		|ИЗ
