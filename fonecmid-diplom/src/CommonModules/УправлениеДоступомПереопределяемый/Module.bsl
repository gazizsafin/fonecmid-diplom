...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	// Профиль для бухгалтера
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "BKM_Бухгалтер";
	ВидДоступа.Представление = НСтр("ru = 'Бухгалтер'");  
	ВидДоступа.ТипЗначений = Тип("СправочникСсылка.ВКМ_Подразделения");
   	
	// Профиль для кадровика‑расчетчика
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "BKM_Кадровик-расчетчик";
	ВидДоступа.Представление = НСтр("ru = 'Кадровик‑расчетчик'");	
	ВидДоступа.ТипЗначений = Тип("СправочникСсылка.BKM_Сотрудники");
	
	// Профиль для специалиста
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "BKM_Специалист";
	ВидДоступа.Представление = НСтр("ru = 'Специалист'");	
	ВидДоступа.ТипЗначений = Тип("СправочникСсылка.ВКМ_ГрафикиРабот");
	
	// Профиль для менеджера по обслуживанию
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "BKM_Менеджер по обслуживанию";
	ВидДоступа.Представление = НСтр("ru = 'Менеджер по обслуживанию'");
	ВидДоступа.ТипЗначений = Тип("СправочникСсылка.BKM_ОбслуживаниеКлиентовПрисоединенныеФайлы");
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументаРеализацияТоваровИУслуг");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеДополнительныхСведений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументаНачисленияЗаработнойПлаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОбработкиЗаполнениеГрафикаРабот");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументаВыплатаЗарплаты");
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОтчетаАнализРасчётыССотрудниками");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОтчетаАнализРасходЗапланированныхОтпусков");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеДополнительныхСведений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("BKM_ДобавлениеИзменениеДокументаОбслуживанияКлиентовСпециалист");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеДополнительныхСведений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("BKM_ДобавлениеИзменениеДокументаОбслуживанияКлиентовМенеджер");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
