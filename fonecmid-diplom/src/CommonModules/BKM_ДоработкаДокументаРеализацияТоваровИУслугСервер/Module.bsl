...
|		ИЗ
|			Константа.ВКМ_НоменклатураАбонентскаяПлата КАК BKM_НоменклатураАбонентскаяПлата
|
|		ОБЪЕДИНИТЬ ВСЕ
|
|		ВЫБРАТЬ
...
|	И
|		РеализацияТоваровУслугУслуги.Ссылка.Договор.ВидДоговора = ЗНАЧЕНИЕ(Перечисление.ВидыДоговоровКонтрагентов.BKM_АбонентскоеОбслуживание)
